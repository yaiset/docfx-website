# <a id="HavanaApp_Trazabilidad"></a> Class Trazabilidad
...
```csharp
public class Trazabilidad : Window, IAnimatable, IFrameworkInputElement, IInputElement, ISupportInitialize, IQueryAmbient, IAddChild
```
...
### <a id="HavanaApp_Trazabilidad__ctor"></a> Trazabilidad\(\)

Constructor de la ventana de trazabilidad, inicializa componentes y establece el manejador de eventos del teclado virtual.
