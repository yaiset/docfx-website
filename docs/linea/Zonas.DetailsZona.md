# <a id="Zonas_DetailsZona"></a> Class DetailsZona
...
```csharp
public class DetailsZona : UserControl, IAnimatable, IFrameworkInputElement, IInputElement, ISupportInitialize, IQueryAmbient, IAddChild
```
...
### <a id="Zonas_DetailsZona__ctor_SQLHandler_ConfiguracionZona_System_Boolean_System_Boolean_System_Boolean_Zonas_Zona_"></a> DetailsZona\(ConfiguracionZona, bool, bool, bool, Zona\)

```csharp
public DetailsZona(ConfiguracionZona configZona, bool basculaActiva, bool PLCActivo, bool RFIDActivo, Zona Zona)
```
...
`basculaActiva` [bool](https://learn.microsoft.com/dotnet/api/system.boolean)

`PLCActivo` [bool](https://learn.microsoft.com/dotnet/api/system.boolean)

`RFIDActivo` [bool](https://learn.microsoft.com/dotnet/api/system.boolean)

`Zona` [Zona](Zonas.Zona.md)

## Fields

### <a id="Zonas_DetailsZona_Collection"></a> Collection

Serie de datos para la colección que alimenta el gráfico.

```csharp
public LineSeries Collection
```
...
### <a id="Zonas_DetailsZona_Grafico"></a> Grafico

Modelo para el gráfico asociado a los datos de la zona.

```csharp
public PlotModel Grafico { get; set; }
```
...
### <a id="Zonas_DetailsZona_AddToCollection_System_Int32_"></a> AddToCollection\(int\)

Agrega un nuevo punto de datos a la colección para la representación gráfica del pesaje.

```csharp
public void AddToCollection(int Peso)
```
...
Valor del peso a añadir.

### <a id="Zonas_DetailsZona_AñadirPesajeGrafico_System_String_"></a> AñadirPesajeGrafico\(string\)

Agrega un peso al gráfico.

```csharp
public void AñadirPesajeGrafico(string Peso)
```

#### Parameters

`Peso` [string](https://learn.microsoft.com/dotnet/api/system.string)

Peso a añadir al gráfico.

### <a id="Zonas_DetailsZona_SetDetallesPLC_System_Boolean_System_Boolean_System_Boolean_System_Boolean_System_Object_"></a> SetDetallesPLC\(bool, bool, bool, bool, object\)

Actualiza los detalles del PLC en la interfaz gráfica.

```csharp
public void SetDetallesPLC(bool StatusTag, bool StatusZona, bool StatusPesaje, bool PesadoOK, object EstadoLinea)
```

#### Parameters

`StatusTag` [bool](https://learn.microsoft.com/dotnet/api/system.boolean)

Estado del tag.

`StatusZona` [bool](https://learn.microsoft.com/dotnet/api/system.boolean)

Estado de la zona.

`StatusPesaje` [bool](https://learn.microsoft.com/dotnet/api/system.boolean)

Estado del pesaje.

`PesadoOK` [bool](https://learn.microsoft.com/dotnet/api/system.boolean)

Indica si el pesaje fue correcto.

`EstadoLinea` [object](https://learn.microsoft.com/dotnet/api/system.object)
