# <a id="Zonas_ZonaTransfer"></a> Class ZonaTransfer
...
```csharp
public class ZonaTransfer : UserControl, IAnimatable, IFrameworkInputElement, IInputElement, ISupportInitialize, IQueryAmbient, IAddChild
```
...
### <a id="Zonas_ZonaTransfer__ctor"></a> ZonaTransfer\(\)

Constructor de la clase ZonaTransfer.
...
### <a id="Zonas_ZonaTransfer_AntenaConectada"></a> AntenaConectada

Indica si la antena está conectada.
...
### <a id="Zonas_ZonaTransfer_BasculaConectada"></a> BasculaConectada
...
### <a id="Zonas_ZonaTransfer_IsWorkingThreadAntena"></a> IsWorkingThreadAntena

Indica si el hilo para la antena está trabajando.
...
### <a id="Zonas_ZonaTransfer_IsWorkingThreadEstadoZona"></a> IsWorkingThreadEstadoZona

Indica si el hilo para el estado de la zona está trabajando.
...
### <a id="Zonas_ZonaTransfer_IsWorkingThreadVariablesPlc"></a> IsWorkingThreadVariablesPlc

Indica si el hilo para las variables del PLC está trabajando.
...
### <a id="Zonas_ZonaTransfer_PlcConectado"></a> PlcConectado

Indica si el PLC está conectado.
...
### <a id="Zonas_ZonaTransfer_AnomaliaSalida"></a> AnomaliaSalida

Indica si hay una anomalía de salida.
...
### <a id="Zonas_ZonaTransfer_ContadorCiclos"></a> ContadorCiclos
...
### <a id="Zonas_ZonaTransfer_ContenidoArchivoTag"></a> ContenidoArchivoTag

Almacena el contenido del archivo de transferencia.

```csharp
public Dictionary<string, string> ContenidoArchivoTag { get; set; }
```
...
### <a id="Zonas_ZonaTransfer_ExisteRegistroAnterior"></a> ExisteRegistroAnterior

Indica si existe un registro anterior.
...
### <a id="Zonas_ZonaTransfer_HayArchivoTag"></a> HayArchivoTag

Indica si hay un archivo de transferencia disponible.

```csharp
public bool HayArchivoTag { get; set; }
```
...
### <a id="Zonas_ZonaTransfer_HayPaletEnFinal"></a> HayPaletEnFinal

Indica si hay un palet en la posición final.
...
### <a id="Zonas_ZonaTransfer_IdZona"></a> IdZona
...
### <a id="Zonas_ZonaTransfer_PesajeCompletado"></a> PesajeCompletado

Indica si el pesaje se ha completado.
...
### <a id="Zonas_ZonaTransfer_PresenciaSalida"></a> PresenciaSalida

Indica la presencia de salida.
...
### <a id="Zonas_ZonaTransfer_TransferActivo"></a> TransferActivo

Indica si el proceso de transferencia está activo.

```csharp
public bool TransferActivo { get; set; }
```
...
### <a id="Zonas_ZonaTransfer_TransponderEnviado"></a> TransponderEnviado

Indica si el transpondedor ha sido enviado.
...
### <a id="Zonas_ZonaTransfer_AsociarPartesZona_SQLHandler_ParteTrabajo_SQLHandler_ParteTrabajo_"></a> AsociarPartesZona\(ParteTrabajo, ParteTrabajo\)

Asocia las partes de trabajo a la zona.

```csharp
public void AsociarPartesZona(ParteTrabajo ParteLlenado, ParteTrabajo ParteVaciado)
```

#### Parameters

`ParteLlenado` ParteTrabajo

El parte de trabajo del llenado.

`ParteVaciado` ParteTrabajo

El parte de trabajo del vaciado.

### <a id="Zonas_ZonaTransfer_AsociarPlc_PLCs_PLCLegacy_"></a> AsociarPlc\(PLCLegacy\)
...
### <a id="Zonas_ZonaTransfer_CargarConfiguracionZona_System_Int32_SQLHandler_ConectorSQL_"></a> CargarConfiguracionZona\(int, ConectorSQL\)

Carga la configuración de la zona.
...
### <a id="Zonas_ZonaTransfer_ConectarAntena"></a> ConectarAntena\(\)
...
### <a id="Zonas_ZonaTransfer_ConectarBascula"></a> ConectarBascula\(\)
...
### <a id="Zonas_ZonaTransfer_DesconectarBascula"></a> DesconectarBascula\(\)
...
### <a id="Zonas_ZonaTransfer_EsperarTagValido"></a> EsperarTagValido\(\)

Espera a que se reconozca un transpondedor válido.
...
Una tarea que se completa cuando se reconoce un transpondedor válido.

### <a id="Zonas_ZonaTransfer_HandleTransponderReconocido_System_Object_System_Collections_Generic_HashSet_System_String__"></a> HandleTransponderReconocido\(object, HashSet<string\>\)

Maneja el reconocimiento del transpondedor.
...
El conjunto de transpondedores reconocidos.

### <a id="Zonas_ZonaTransfer_IniciarHilosPlc"></a> IniciarHilosPlc\(\)

Inicia los hilos del PLC.

```csharp
public void IniciarHilosPlc()
```

### <a id="Zonas_ZonaTransfer_LeerPesoBascula_System_Object_System_Int32_"></a> LeerPesoBascula\(object, int\)
...
### <a id="Zonas_ZonaTransfer_LeerPesoEstableBascula_System_Object_System_Int32_"></a> LeerPesoEstableBascula\(object, int\)

Lee el peso estable de la báscula.
...
### <a id="Zonas_ZonaTransfer_ProcesarVariablePlc_PLCs_EstructurasPLC_DatosPLC_"></a> ProcesarVariablePlc\(DatosPLC\)

Procesa la variable del PLC.
...
### <a id="Zonas_ZonaTransfer_StartHiloBascula"></a> StartHiloBascula\(\)

Inicia el hilo de la báscula.

```csharp
public void StartHiloBascula()
```

### <a id="Zonas_ZonaTransfer_StartZona"></a> StartZona\(\)
