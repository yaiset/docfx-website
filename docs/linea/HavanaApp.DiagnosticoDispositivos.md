# <a id="HavanaApp_DiagnosticoDispositivos"></a> Class DiagnosticoDispositivos
...
```csharp
public class DiagnosticoDispositivos : UserControl, IAnimatable, IFrameworkInputElement, IInputElement, ISupportInitialize, IQueryAmbient, IAddChild
```
...
### <a id="HavanaApp_DiagnosticoDispositivos__ctor"></a> DiagnosticoDispositivos\(\)

Constructor de la clase DiagnosticoDispositivos.

```csharp
public DiagnosticoDispositivos()
```

## Methods

### <a id="HavanaApp_DiagnosticoDispositivos_RenderListaRFID_System_Collections_Generic_List_System_String__System_Collections_Generic_List_System_String__"></a> RenderListaRFID\(List<string\>, List<string\>\)

Renderiza la lista de RFID y sus respectivos puertos para el diagnóstico.

```csharp
public void RenderListaRFID(List<string> ListaRFIDs, List<string> ListaPuertosRFIDs)
```

#### Parameters

`ListaRFIDs` [List](https://learn.microsoft.com/dotnet/api/system.collections.generic.list\-1)<[string](https://learn.microsoft.com/dotnet/api/system.string)\>

Lista de identificadores RFID.

`ListaPuertosRFIDs` [List](https://learn.microsoft.com/dotnet/api/system.collections.generic.list\-1)<[string](https://learn.microsoft.com/dotnet/api/system.string)\>

Lista de puertos asociados a los identificadores RFID.
