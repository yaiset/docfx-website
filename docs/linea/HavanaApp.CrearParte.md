# <a id="HavanaApp_CrearParte"></a> Class CrearParte
...
```csharp
public class CrearParte : Window, IAnimatable, IFrameworkInputElement, IInputElement, ISupportInitialize, IQueryAmbient, IAddChild
```
...
### <a id="HavanaApp_CrearParte__ctor_SQLHandler_Parte_SQLHandler_ParteTrabajo_"></a> CrearParte\(Parte, ParteTrabajo\)

Inicializa una nueva instancia de la clase CrearParte.

```csharp
public CrearParte(Parte TipoParte, ParteTrabajo DatosParte)
```
...
### <a id="HavanaApp_CrearParte_OnFormSubmit_SQLHandler_ParteTrabajo_"></a> OnFormSubmit\(ParteTrabajo\)

Invoca el evento de envío de formulario de parte de trabajo.

```csharp
public void OnFormSubmit(ParteTrabajo Datos)
```
...
### <a id="HavanaApp_CrearParte_OnSetTipoParte_SQLHandler_Parte_"></a> OnSetTipoParte\(Parte\)

Invoca el evento para establecer el tipo de parte.

```csharp
public void OnSetTipoParte(Parte TipoParte)
```
...
El tipo de parte a establecer.

### <a id="HavanaApp_CrearParte_FormSubmit"></a> FormSubmit

Evento que se desencadena al enviar un formulario de parte de trabajo.

```csharp
public event EventHandler<ParteTrabajo> FormSubmit
```

#### Event Type

 [EventHandler](https://learn.microsoft.com/dotnet/api/system.eventhandler\-1)<ParteTrabajo\>

### <a id="HavanaApp_CrearParte_SetTipoParte"></a> SetTipoParte

Evento invocado para establecer el tipo de parte.

```csharp
public event EventHandler<Parte> SetTipoParte
```

#### Event Type

 [EventHandler](https://learn.microsoft.com/dotnet/api/system.eventhandler\-1)<Parte\>
