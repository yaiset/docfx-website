# <a id="HavanaApp_DiagnosticoRFID"></a> Class DiagnosticoRFID
...
```csharp
public class DiagnosticoRFID : Window, IAnimatable, IFrameworkInputElement, IInputElement, ISupportInitialize, IQueryAmbient, IAddChild
```
...
### <a id="HavanaApp_DiagnosticoRFID__ctor_SQLHandler_ConectorSQL_"></a> DiagnosticoRFID\(ConectorSQL\)

Constructor de la clase DiagnosticoRFID.

```csharp
public DiagnosticoRFID(ConectorSQL SQL)
```
...
Conector para la base de datos SQL.
