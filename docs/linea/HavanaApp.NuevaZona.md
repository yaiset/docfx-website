# <a id="HavanaApp_NuevaZona"></a> Class NuevaZona
...
```csharp
public class NuevaZona : Window, IAnimatable, IFrameworkInputElement, IInputElement, ISupportInitialize, IQueryAmbient, IAddChild
```
...
### <a id="HavanaApp_NuevaZona__ctor"></a> NuevaZona\(\)

Constructor de la clase NuevaZona.
