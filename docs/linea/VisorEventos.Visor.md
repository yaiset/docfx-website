# <a id="VisorEventos_Visor"></a> Class Visor

Namespace: [VisorEventos](VisorEventos.md)  
Assembly: VisorEventos.dll  

Clase que representa un visor utilizado para la visualización y gestión de datos.

```csharp
public class Visor : UserControl, IAnimatable, IFrameworkInputElement, IInputElement, ISupportInitialize, IQueryAmbient, IAddChild
```
...
### <a id="VisorEventos_Visor__ctor"></a> Visor\(\)

Constructor de la clase Visor que inicializa y carga elementos al crearse una instancia.
...
### <a id="VisorEventos_Visor_DateTimeToMySQLDate_System_String_"></a> DateTimeToMySQLDate\(string\)

Convierte una fecha y hora en formato de cadena a un formato compatible con MySQL (YYYY-MM-DD HH:mm:ss).

```csharp
public static string DateTimeToMySQLDate(string DateTime)
```

#### Parameters

`DateTime` [string](https://learn.microsoft.com/dotnet/api/system.string)

Fecha y hora en formato de cadena a convertir.

#### Returns

 [string](https://learn.microsoft.com/dotnet/api/system.string)

Fecha y hora en formato MySQL.

### <a id="VisorEventos_Visor_GetTipoFiltro"></a> GetTipoFiltro\(\)

Obtiene el tipo de filtro seleccionado.
...
El tipo de filtro seleccionado como una cadena.

### <a id="VisorEventos_Visor_LoadComboBox_System_Collections_Generic_List_System_String__"></a> LoadComboBox\(List<string\>\)

Carga una lista de cadenas en el origen de datos del ComboBox.

```csharp
public void LoadComboBox(List<string> Lista)
```

#### Parameters

`Lista` [List](https://learn.microsoft.com/dotnet/api/system.collections.generic.list\-1)<[string](https://learn.microsoft.com/dotnet/api/system.string)\>

Lista de cadenas a cargar en el ComboBox.
