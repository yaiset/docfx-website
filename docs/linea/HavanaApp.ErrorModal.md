# <a id="HavanaApp_ErrorModal"></a> Class ErrorModal
...
```csharp
public class ErrorModal : Window, IAnimatable, IFrameworkInputElement, IInputElement, ISupportInitialize, IQueryAmbient, IAddChild
```
...
### <a id="HavanaApp_ErrorModal__ctor"></a> ErrorModal\(\)
...
### <a id="HavanaApp_ErrorModal_SetDescripcion_System_String_"></a> SetDescripcion\(string\)

Cambia el texto descriptivo del modal.
...
### <a id="HavanaApp_ErrorModal_SetTitle_System_String_"></a> SetTitle\(string\)
