# <a id="Zonas_ZonaTransfer_ReseteoZonaException"></a> Class ZonaTransfer.ReseteoZonaException
...
```csharp
public class ZonaTransfer.ReseteoZonaException : Exception, ISerializable, _Exception
```
...
### <a id="Zonas_ZonaTransfer_ReseteoZonaException__ctor_System_String_"></a> ReseteoZonaException\(string\)

Constructor de la clase ReseteoZonaException.
