# <a id="HavanaApp_Index"></a> Class Index

Namespace: [HavanaApp](HavanaApp.md)  
Assembly: HavanaApp.dll  

```csharp
public class Index : Window, IAnimatable, IFrameworkInputElement, IInputElement, ISupportInitialize, IQueryAmbient, IAddChild
```
...
### <a id="HavanaApp_Index__ctor"></a> Index\(\)

Constructor de la ventana, prepara todas las variables previas para el funcionamiento.
...
### <a id="HavanaApp_Index_UserClass"></a> UserClass

Clase que alberga el usuario actual.

```csharp
public Usuario UserClass { get; set; }
```
