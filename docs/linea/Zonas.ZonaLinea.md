# <a id="Zonas_ZonaLinea"></a> Class ZonaLinea
...
```csharp
public class ZonaLinea : UserControl, IAnimatable, IFrameworkInputElement, IInputElement, ISupportInitialize, IQueryAmbient, IAddChild
```
...
### <a id="Zonas_ZonaLinea__ctor"></a> ZonaLinea\(\)

Constructor que inicializa los componentes de la zona de línea.
...
### <a id="Zonas_ZonaLinea_AntenaConectada"></a> AntenaConectada

Propiedad que indica si la antena está conectada.
...
### <a id="Zonas_ZonaLinea_BasculaConectada"></a> BasculaConectada

Propiedad que indica si la báscula está conectada.
...
### <a id="Zonas_ZonaLinea_IsWorkingThreadAntena"></a> IsWorkingThreadAntena

Propiedad que indica si el hilo de la antena RFID está trabajando.
...
### <a id="Zonas_ZonaLinea_IsWorkingThreadEstadoZona"></a> IsWorkingThreadEstadoZona

Propiedad que indica si el hilo de estado de la zona está trabajando.
...
### <a id="Zonas_ZonaLinea_IsWorkingThreadVariablesPlc"></a> IsWorkingThreadVariablesPlc

Propiedad que indica si el hilo de variables del PLC está trabajando.
...
### <a id="Zonas_ZonaLinea_PlcConectado"></a> PlcConectado

Propiedad que indica si el PLC está conectado.
...
### <a id="Zonas_ZonaLinea_AnomaliaSalida"></a> AnomaliaSalida

Propiedad que indica si hay una anomalía en la salida de la zona.
...
### <a id="Zonas_ZonaLinea_ContadorCiclos"></a> ContadorCiclos

Propiedad que almacena el contador de ciclos de la zona.
...
### <a id="Zonas_ZonaLinea_ExisteRegistroAnterior"></a> ExisteRegistroAnterior

Propiedad que indica si existe un registro anterior de la zona en la base de datos.
...
### <a id="Zonas_ZonaLinea_HayPaletEnFinal"></a> HayPaletEnFinal
...
### <a id="Zonas_ZonaLinea_IdZona"></a> IdZona

Propiedad que almacena el identificador de la zona.
...
### <a id="Zonas_ZonaLinea_PesajeCompletado"></a> PesajeCompletado

Propiedad que indica si el pesaje ha sido completado.
...
### <a id="Zonas_ZonaLinea_PresenciaSalida"></a> PresenciaSalida

Propiedad que indica si hay presencia en la salida de la zona.
...
### <a id="Zonas_ZonaLinea_TransponderEnviado"></a> TransponderEnviado

Propiedad que indica si el transponder ha sido enviado.
...
### <a id="Zonas_ZonaLinea_AsociarParteZona_SQLHandler_ParteTrabajo_"></a> AsociarParteZona\(ParteTrabajo\)
...
### <a id="Zonas_ZonaLinea_AsociarPlc_PLCs_PLCLegacy_"></a> AsociarPlc\(PLCLegacy\)
...
### <a id="Zonas_ZonaLinea_CargarConfiguracionZona_System_Int32_SQLHandler_ConectorSQL_"></a> CargarConfiguracionZona\(int, ConectorSQL\)
...
### <a id="Zonas_ZonaLinea_ConectarAntena"></a> ConectarAntena\(\)
...
### <a id="Zonas_ZonaLinea_ConectarBascula"></a> ConectarBascula\(\)
...
### <a id="Zonas_ZonaLinea_DesconectarBascula"></a> DesconectarBascula\(\)
...
### <a id="Zonas_ZonaLinea_EsperarTagValido"></a> EsperarTagValido\(\)
...
### <a id="Zonas_ZonaLinea_HandleTransponderReconocido_System_Object_System_Collections_Generic_HashSet_System_String__"></a> HandleTransponderReconocido\(object, HashSet<string\>\)

Método que maneja el evento de transponder reconocido por la antena RFID.
...
### <a id="Zonas_ZonaLinea_IniciarHilosPlc"></a> IniciarHilosPlc\(\)
...
### <a id="Zonas_ZonaLinea_LeerPesoBascula_System_Object_System_Int32_"></a> LeerPesoBascula\(object, int\)
...
### <a id="Zonas_ZonaLinea_LeerPesoEstableBascula_System_Object_System_Int32_"></a> LeerPesoEstableBascula\(object, int\)
...
### <a id="Zonas_ZonaLinea_ProcesarVariablePlc_PLCs_EstructurasPLC_DatosPLC_"></a> ProcesarVariablePlc\(DatosPLC\)
...
### <a id="Zonas_ZonaLinea_StartHiloAntena"></a> StartHiloAntena\(\)
...
### <a id="Zonas_ZonaLinea_StartHiloBascula"></a> StartHiloBascula\(\)
...
### <a id="Zonas_ZonaLinea_StartZona"></a> StartZona\(\)
