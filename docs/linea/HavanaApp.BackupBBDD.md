# <a id="HavanaApp_BackupBBDD"></a> Class BackupBBDD
...
```csharp
public class BackupBBDD : Window, IAnimatable, IFrameworkInputElement, IInputElement, ISupportInitialize, IQueryAmbient, IAddChild
```
...
### <a id="HavanaApp_BackupBBDD__ctor"></a> BackupBBDD\(\)

Inicializa una nueva instancia de la clase BackupBBDD.
