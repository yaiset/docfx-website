# <a id="Zonas_ZonaEntrada_ReseteoZonaException"></a> Class ZonaEntrada.ReseteoZonaException
...
```csharp
public class ZonaEntrada.ReseteoZonaException : Exception, ISerializable, _Exception
```
...
### <a id="Zonas_ZonaEntrada_ReseteoZonaException__ctor_System_String_"></a> ReseteoZonaException\(string\)

Inicializa una nueva instancia de la clase ReseteoZonaException con un mensaje de error especificado.
