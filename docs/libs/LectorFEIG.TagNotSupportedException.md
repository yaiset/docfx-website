# <a id="LectorFEIG_TagNotSupportedException"></a> Class TagNotSupportedException
...
### <a id="LectorFEIG_TagNotSupportedException__ctor"></a> TagNotSupportedException\(\)

Inicializa una nueva instancia de la clase TagNotSupportedException sin especificar un mensaje de error.

```csharp
public TagNotSupportedException()
```

### <a id="LectorFEIG_TagNotSupportedException__ctor_System_String_"></a> TagNotSupportedException\(string\)

Inicializa una nueva instancia de la clase TagNotSupportedException con un mensaje de error especificado.
...
### <a id="LectorFEIG_TagNotSupportedException__ctor_System_String_System_Exception_"></a> TagNotSupportedException\(string, Exception\)

Inicializa una nueva instancia de la clase TagNotSupportedException con un mensaje de error especificado y una referencia a la excepción interna que es la causa de esta excepción.
