# <a id="TecladoVirtual_TecladoVirtual"></a> Class TecladoVirtual

Namespace: [TecladoVirtual](TecladoVirtual.md)  
Assembly: TecladoVirtual.dll  

Lógica de interacción para TecladoVirtual.xaml

```csharp
public class TecladoVirtual : UserControl, IAnimatable, IFrameworkInputElement, IInputElement, ISupportInitialize, IQueryAmbient, IAddChild
```
...
### <a id="TecladoVirtual_TecladoVirtual__ctor"></a> TecladoVirtual\(\)
...
### <a id="TecladoVirtual_TecladoVirtual_ActivateKeyboardCaps_System_Object_System_Windows_RoutedEventArgs_"></a> ActivateKeyboardCaps\(object, RoutedEventArgs\)

Activa o desactiva las mayúsculas

```csharp
public void ActivateKeyboardCaps(object sender, RoutedEventArgs ex)
```
...
`ex` [RoutedEventArgs](https://learn.microsoft.com/dotnet/api/system.windows.routedeventargs)

### <a id="TecladoVirtual_TecladoVirtual_BindEnterHandler_System_Windows_RoutedEventHandler_"></a> BindEnterHandler\(RoutedEventHandler\)

Bindea la función de "Enter" a la función específica

```csharp
public void BindEnterHandler(RoutedEventHandler Function)
```

#### Parameters

`Function` [RoutedEventHandler](https://learn.microsoft.com/dotnet/api/system.windows.routedeventhandler)

### <a id="TecladoVirtual_TecladoVirtual_DelButton_System_Object_System_Windows_RoutedEventArgs_"></a> DelButton\(object, RoutedEventArgs\)

Borra el último caracter de el elemento que tenga foco
...
### <a id="TecladoVirtual_TecladoVirtual_HideVKeyboard_System_Object_System_Windows_RoutedEventArgs_"></a> HideVKeyboard\(object, RoutedEventArgs\)

Oculta el teclado virtual

```csharp
public void HideVKeyboard(object sender, RoutedEventArgs e)
```
...
### <a id="TecladoVirtual_TecladoVirtual_PrintButton_System_Object_System_Windows_RoutedEventArgs_"></a> PrintButton\(object, RoutedEventArgs\)

Escribe el botón pulsado en el elemento que tenga foco

```csharp
public void PrintButton(object sender, RoutedEventArgs e)
```
