# <a id="LectorFEIG_DuplicatedTagException"></a> Class DuplicatedTagException
...
### <a id="LectorFEIG_DuplicatedTagException__ctor"></a> DuplicatedTagException\(\)

Inicializa una nueva instancia de la clase DuplicatedTagException sin especificar un mensaje de error.

```csharp
public DuplicatedTagException()
```

### <a id="LectorFEIG_DuplicatedTagException__ctor_System_String_"></a> DuplicatedTagException\(string\)

Inicializa una nueva instancia de la clase DuplicatedTagException con un mensaje de error especificado.
...
### <a id="LectorFEIG_DuplicatedTagException__ctor_System_String_System_Exception_"></a> DuplicatedTagException\(string, Exception\)

Inicializa una nueva instancia de la clase DuplicatedTagException con un mensaje de error especificado y una referencia a la excepción interna que es la causa de esta excepción.
