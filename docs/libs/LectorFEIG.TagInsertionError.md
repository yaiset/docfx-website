# <a id="LectorFEIG_TagInsertionError"></a> Class TagInsertionError
...
### <a id="LectorFEIG_TagInsertionError__ctor"></a> TagInsertionError\(\)

Inicializa una nueva instancia de la clase TagInsertionError sin especificar un mensaje de error.

```csharp
public TagInsertionError()
```

### <a id="LectorFEIG_TagInsertionError__ctor_System_String_"></a> TagInsertionError\(string\)

Inicializa una nueva instancia de la clase TagInsertionError con un mensaje de error especificado.
...
### <a id="LectorFEIG_TagInsertionError__ctor_System_String_System_Exception_"></a> TagInsertionError\(string, Exception\)

Inicializa una nueva instancia de la clase TagInsertionError con un mensaje de error especificado y una referencia a la excepción interna que es la causa de esta excepción.
