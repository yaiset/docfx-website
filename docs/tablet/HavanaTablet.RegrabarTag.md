# <a id="HavanaTablet_RegrabarTag"></a> Class RegrabarTag
...
```csharp
public class RegrabarTag : Window, IAnimatable, IFrameworkInputElement, IInputElement, ISupportInitialize, IQueryAmbient, IAddChild
```
...
### <a id="HavanaTablet_RegrabarTag__ctor_System_Data_SqlClient_SqlConnection_LectorFEIG_LectorCOM_"></a> RegrabarTag\(SqlConnection, LectorCOM\)

Constructor de la clase.

```csharp
public RegrabarTag(SqlConnection dbconn, LectorCOM LectorRFID)
```
