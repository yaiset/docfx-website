# <a id="Escaner_Transponders_Escaner"></a> Class Escaner
...
```csharp
public class Escaner : UserControl, IAnimatable, IFrameworkInputElement, IInputElement, ISupportInitialize, IQueryAmbient, IAddChild
```
...
### <a id="Escaner_Transponders_Escaner__ctor_LectorFEIG_LectorCOM_System_Data_SqlClient_SqlConnection_"></a> Escaner\(LectorCOM, SqlConnection\)

Constructor de la clase Escaner.
Inicializa una instancia de Escaner con un lector de comunicación y una conexión a la base de datos.

```csharp
public Escaner(LectorCOM Antena, SqlConnection Conn)
```
...
Instancia del lector de comunicación.
...
### <a id="Escaner_Transponders_Escaner_AddTagToList_System_String_"></a> AddTagToList\(string\)

Agrega un elemento a la lista de transponders con el mensaje proporcionado.
...
Mensaje a agregar a la lista de transponders.

### <a id="Escaner_Transponders_Escaner_ClearTagList"></a> ClearTagList\(\)

Limpia la lista de elementos de la fuente de datos de la lista de transponders.

```csharp
public void ClearTagList()
```

### <a id="Escaner_Transponders_Escaner_MarcarLineaMigrada_System_String_System_String_"></a> MarcarLineaMigrada\(string, string\)

Marca una línea de producción como migrada en la base de datos.

```csharp
public bool MarcarLineaMigrada(string Lote, string NumeroPaleta)
```
...
El número de lote de la línea de producción.

`NumeroPaleta` [string](https://learn.microsoft.com/dotnet/api/system.string)

El número de paleta asociado a la línea de producción.

#### Returns

 [bool](https://learn.microsoft.com/dotnet/api/system.boolean)

Verdadero si la línea se marcó como migrada; de lo contrario, falso.

### <a id="Escaner_Transponders_Escaner_MigrarLineaProduccion_SQLHandler_HistoricoData_System_String_"></a> MigrarLineaProduccion\(HistoricoData, string\)

Migra los datos de una línea de producción a la base de datos.

```csharp
public bool MigrarLineaProduccion(HistoricoData Datos, string TagID)
```
...
Los datos históricos de la línea de producción a migrar.

`TagID` [string](https://learn.microsoft.com/dotnet/api/system.string)

El identificador del RFID asociado a la línea de producción.

#### Returns

 [bool](https://learn.microsoft.com/dotnet/api/system.boolean)

Verdadero si la migración fue exitosa; de lo contrario, falso.

### <a id="Escaner_Transponders_Escaner_OpenModalTransponderVacio"></a> OpenModalTransponderVacio\(\)

Abre una ventana modal para introducir datos del transponder.

```csharp
public void OpenModalTransponderVacio()
```

#### Remarks

Este método está actualmente comentado y no se está utilizando.

### <a id="Escaner_Transponders_Escaner_SetSemaforo_Escaner_Transponders_ColoresSemaforo_"></a> SetSemaforo\(ColoresSemaforo\)

Establece el color del semáforo visual en la interfaz gráfica.

```csharp
public void SetSemaforo(ColoresSemaforo color)
```

#### Parameters

`color` [ColoresSemaforo](Escaner\_Transponders.ColoresSemaforo.md)

El color del semáforo a establecer.

### <a id="Escaner_Transponders_Escaner_SetTransponder_System_String_"></a> SetTransponder\(string\)

Establece el contenido del identificador del transponder en la interfaz gráfica.
...
El identificador del transponder a mostrar.

### <a id="Escaner_Transponders_Escaner_ShowDatosGrabados_TagData_"></a> ShowDatosGrabados\(TagData\)

Muestra los datos grabados de un objeto TagData en los elementos de la interfaz gráfica correspondientes.

```csharp
public void ShowDatosGrabados(TagData Datos)
```
...
El objeto TagData que contiene los datos a mostrar.
