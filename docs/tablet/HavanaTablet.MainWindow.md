# <a id="HavanaTablet_MainWindow"></a> Class MainWindow
...
```csharp
public class MainWindow : Window, IAnimatable, IFrameworkInputElement, IInputElement, ISupportInitialize, IQueryAmbient, IAddChild
```
...
### <a id="HavanaTablet_MainWindow__ctor_SQLHandler_Usuario_"></a> MainWindow\(Usuario\)
...
El usuario actual que accede a la ventana.

## Fields

### <a id="HavanaTablet_MainWindow_AntenaRFID"></a> AntenaRFID

Representa una instancia del lector RFID para operaciones de lectura y escritura.

```csharp
public LectorCOM AntenaRFID
```
...
### <a id="HavanaTablet_MainWindow_CambiarPestaña_System_Object_HandyControl_Data_FunctionEventArgs_System_Object__"></a> CambiarPestaña\(object, FunctionEventArgs<object\>\)

Cambia la pestaña de la interfaz según la opción seleccionada en el menú lateral.

```csharp
public void CambiarPestaña(object sender, HandyControl.Data.FunctionEventArgs<object> e)
```
...
El objeto que desencadena el cambio de pestaña.

`e` HandyControl.Data.FunctionEventArgs<[object](https://learn.microsoft.com/dotnet/api/system.object)\>

Argumentos del evento que contienen información sobre la pestaña seleccionada.

### <a id="HavanaTablet_MainWindow_GetBluetoothDeviceAddressFromComPort_System_String_"></a> GetBluetoothDeviceAddressFromComPort\(string\)

Obtiene la dirección del dispositivo Bluetooth asociado al puerto COM especificado.

```csharp
public string GetBluetoothDeviceAddressFromComPort(string comPort)
```
...
El puerto COM del que se obtendrá la dirección del dispositivo Bluetooth.

#### Returns

 [string](https://learn.microsoft.com/dotnet/api/system.string)

La dirección del dispositivo Bluetooth o null si no se encuentra.

### <a id="HavanaTablet_MainWindow_GetComPortOfDeviceWithName_System_String_"></a> GetComPortOfDeviceWithName\(string\)

Obtiene el puerto COM del dispositivo Bluetooth con el nombre especificado.

```csharp
public string GetComPortOfDeviceWithName(string name)
```
...
El puerto COM del dispositivo Bluetooth correspondiente al nombre dado.

### <a id="HavanaTablet_MainWindow_ShowGrid_System_String_"></a> ShowGrid\(string\)

Método que muestra una cuadrícula específica en la interfaz de usuario.
...
`Grid` [string](https://learn.microsoft.com/dotnet/api/system.string)

El nombre de la cuadrícula a mostrar.
