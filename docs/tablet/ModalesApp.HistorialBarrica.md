# <a id="ModalesApp_HistorialBarrica"></a> Class HistorialBarrica
...
```csharp
public class HistorialBarrica : UserControl, IAnimatable, IFrameworkInputElement, IInputElement, ISupportInitialize, IQueryAmbient, IAddChild
```
...
### <a id="ModalesApp_HistorialBarrica__ctor_LectorFEIG_LectorCOM_SQLHandler_ConectorSQL_"></a> HistorialBarrica\(LectorCOM, ConectorSQL\)

Constructor de la clase HistorialBarrica.

```csharp
public HistorialBarrica(LectorCOM AntenaRFID, ConectorSQL dbconn)
```

#### Parameters

`AntenaRFID` LectorCOM

Antena RFID para escaneo.
...
### <a id="ModalesApp_HistorialBarrica_Antena"></a> Antena

Antena RFID utilizada para escanear transponders.

```csharp
public LectorCOM Antena
```
...
### <a id="ModalesApp_HistorialBarrica_BotonHistorial"></a> BotonHistorial
...
### <a id="ModalesApp_HistorialBarrica_ListaProduccion"></a> ListaProduccion

DataGrid que muestra la producción.

```csharp
public DataGrid ListaProduccion
```
...
### <a id="ModalesApp_HistorialBarrica__IntroducirDatos"></a> \_IntroducirDatos

Representa la cuadrícula de introducción de datos.

```csharp
public Grid _IntroducirDatos
```
...
### <a id="ModalesApp_HistorialBarrica__Tabla"></a> \_Tabla

Representa la cuadrícula de datos.
...
### <a id="ModalesApp_HistorialBarrica_GetTransponderIntroducido"></a> GetTransponderIntroducido\(\)

Obtiene el valor del transpondedor introducido.

```csharp
public string GetTransponderIntroducido()
```
...
El valor del transpondedor introducido.
