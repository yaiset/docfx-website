# <a id="HavanaTablet_MigrarRegistros"></a> Class MigrarRegistros
...
```csharp
public class MigrarRegistros : Window, IAnimatable, IFrameworkInputElement, IInputElement, ISupportInitialize, IQueryAmbient, IAddChild
```
...
### <a id="HavanaTablet_MigrarRegistros__ctor_System_Data_SqlClient_SqlConnection_"></a> MigrarRegistros\(SqlConnection\)

Constructor de la clase MigrarRegistros.

```csharp
public MigrarRegistros(SqlConnection ConnectionDB)
```
...
La conexión a la base de datos SQL.

## Fields

### <a id="HavanaTablet_MigrarRegistros_ConectorDB"></a> ConectorDB
...
### <a id="HavanaTablet_MigrarRegistros_DatosTag"></a> DatosTag

Los datos del tag a escribir manualmente.
...
### <a id="HavanaTablet_MigrarRegistros_Datos"></a> Datos

Los datos del registro de pesaje seleccionado.

```csharp
public RegistroPesaje Datos { get; set; }
```
...
### <a id="HavanaTablet_MigrarRegistros_GetDatosHistoricosFromDB_System_String_"></a> GetDatosHistoricosFromDB\(string\)

Obtiene los datos históricos de un lote desde la base de datos SQL.

```csharp
public RegistroPesaje GetDatosHistoricosFromDB(string Lote)
```
...
El número de lote a consultar.

#### Returns

 RegistroPesaje

Los datos del registro de pesaje asociado al lote.

### <a id="HavanaTablet_MigrarRegistros_GetHistoricoLotesFromDB"></a> GetHistoricoLotesFromDB\(\)

Obtiene la lista de lotes históricos desde la base de datos SQL.
...
La lista de lotes históricos.

### <a id="HavanaTablet_MigrarRegistros_RaiseFormSubmit_SQLHandler_RegistroPesaje_"></a> RaiseFormSubmit\(RegistroPesaje\)

Invoca el evento de enviar el formulario de migración de datos.

```csharp
protected virtual void RaiseFormSubmit(RegistroPesaje Datos)
```
...
### <a id="HavanaTablet_MigrarRegistros_SetComboBoxes"></a> SetComboBoxes\(\)

Establece los elementos del combo box de lotes con la lista de lotes históricos.

```csharp
public void SetComboBoxes()
```

### <a id="HavanaTablet_MigrarRegistros_OnFormManualSubmit"></a> OnFormManualSubmit

El evento que se produce cuando se envía el formulario de escritura manual de datos en un tag.

```csharp
public event MigrarRegistros.FormManualSubmit OnFormManualSubmit
```

#### Event Type

 [MigrarRegistros](HavanaTablet.MigrarRegistros.md).[FormManualSubmit](HavanaTablet.MigrarRegistros.FormManualSubmit.md)

### <a id="HavanaTablet_MigrarRegistros_OnFormSubmit"></a> OnFormSubmit

El evento que se produce cuando se envía el formulario de migración de datos.

```csharp
public event MigrarRegistros.FormSubmit OnFormSubmit
```

#### Event Type

 [MigrarRegistros](HavanaTablet.MigrarRegistros.md).[FormSubmit](HavanaTablet.MigrarRegistros.FormSubmit.md)
