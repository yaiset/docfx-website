# <a id="ModalesApp_DatosTransponder"></a> Class DatosTransponder
...
```csharp
public class DatosTransponder : UserControl, IAnimatable, IFrameworkInputElement, IInputElement, ISupportInitialize, IQueryAmbient, IAddChild
```
...
### <a id="ModalesApp_DatosTransponder__ctor_System_Data_SqlClient_SqlConnection_"></a> DatosTransponder\(SqlConnection\)

Constructor de la clase DatosTransponder.

```csharp
public DatosTransponder(SqlConnection ConnectionDB)
```

#### Parameters

`ConnectionDB` [SqlConnection](https://learn.microsoft.com/dotnet/api/system.data.sqlclient.sqlconnection)

Conexión a la base de datos.

## Fields

### <a id="ModalesApp_DatosTransponder_ConectorDB"></a> ConectorDB

Conexión a la base de datos SQL.

```csharp
public SqlConnection ConectorDB
```
...
### <a id="ModalesApp_DatosTransponder_Datos"></a> Datos

Almacena datos históricos.

```csharp
public HistoricoData Datos
```
...
### <a id="ModalesApp_DatosTransponder_DatosTag"></a> DatosTag

Almacena datos de un transponder.

```csharp
public TagData DatosTag
```
...
### <a id="ModalesApp_DatosTransponder_GetDatosHistoricosFromDB_System_String_System_String_"></a> GetDatosHistoricosFromDB\(string, string\)

Obtiene datos históricos de la base de datos correspondientes a un lote y número de paleta específicos.

```csharp
public HistoricoData GetDatosHistoricosFromDB(string Lote, string NumeroPaleta)
```
...
Número de lote para filtrar los datos históricos.

`NumeroPaleta` [string](https://learn.microsoft.com/dotnet/api/system.string)

Número de paleta para filtrar los datos históricos.

#### Returns

 HistoricoData

Objeto HistoricoData que contiene los datos históricos recuperados de la base de datos.

### <a id="ModalesApp_DatosTransponder_GetHistoricoLotesFromDB"></a> GetHistoricoLotesFromDB\(\)

Obtiene una lista de números de lotes históricos que aún no han sido migrados.
Devuelve una lista de cadenas que representan los números de lote.

```csharp
public List<string> GetHistoricoLotesFromDB()
```
...
Lista de cadenas que representan los números de lote no migrados.

### <a id="ModalesApp_DatosTransponder_GetHistoricoPaletsFromLote_System_String_"></a> GetHistoricoPaletsFromLote\(string\)

Obtiene una lista de números de paletas históricas asociadas a un lote específico que aún no han sido migradas.

```csharp
public List<string> GetHistoricoPaletsFromLote(string Lote)
```
...
Número de lote para el cual se busca el historial de paletas.

#### Returns

 [List](https://learn.microsoft.com/dotnet/api/system.collections.generic.list\-1)<[string](https://learn.microsoft.com/dotnet/api/system.string)\>

Una lista de números de paletas históricas no migradas asociadas al lote.

### <a id="ModalesApp_DatosTransponder_RaiseFormSubmit_SQLHandler_HistoricoData_"></a> RaiseFormSubmit\(HistoricoData\)

Método para disparar el evento de envío de datos históricos.

```csharp
protected virtual void RaiseFormSubmit(HistoricoData Datos)
```
...
Datos históricos a enviar.

### <a id="ModalesApp_DatosTransponder_SetComboBoxes"></a> SetComboBoxes\(\)

Configura el origen de datos para ComboBoxLote con la lista de lotes históricos obtenidos de la base de datos.

```csharp
public void SetComboBoxes()
```

### <a id="ModalesApp_DatosTransponder_OnFormManualSubmit"></a> OnFormManualSubmit

Evento que se activa al enviar manualmente los datos del transponder.

```csharp
public event DatosTransponder.FormManualSubmit OnFormManualSubmit
```

#### Event Type

 [DatosTransponder](ModalesApp.DatosTransponder.md).[FormManualSubmit](ModalesApp.DatosTransponder.FormManualSubmit.md)

### <a id="ModalesApp_DatosTransponder_OnFormSubmit"></a> OnFormSubmit

Evento que se dispara cuando se envían los datos del histórico.

```csharp
public event DatosTransponder.FormSubmit OnFormSubmit
```

#### Event Type

 [DatosTransponder](ModalesApp.DatosTransponder.md).[FormSubmit](ModalesApp.DatosTransponder.FormSubmit.md)
