# <a id="ModalesApp_SustitucionTag"></a> Class SustitucionTag
...
```csharp
public class SustitucionTag : UserControl, IAnimatable, IFrameworkInputElement, IInputElement, ISupportInitialize, IQueryAmbient, IAddChild
```
...
### <a id="ModalesApp_SustitucionTag__ctor_LectorFEIG_LectorCOM_System_Data_SqlClient_SqlConnection_"></a> SustitucionTag\(LectorCOM, SqlConnection\)

Constructor para la clase SustitucionTag.

```csharp
public SustitucionTag(LectorCOM Antena, SqlConnection Conn)
```
