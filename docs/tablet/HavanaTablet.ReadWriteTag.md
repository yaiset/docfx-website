# <a id="HavanaTablet_ReadWriteTag"></a> Class ReadWriteTag
...
```csharp
public class ReadWriteTag : Window, IAnimatable, IFrameworkInputElement, IInputElement, ISupportInitialize, IQueryAmbient, IAddChild
```
...
### <a id="HavanaTablet_ReadWriteTag__ctor_LectorFEIG_LectorCOM_"></a> ReadWriteTag\(LectorCOM\)

El constructor de la clase, que inicializa los componentes de la interfaz gráfica y asigna el objeto LectorFEIG.LectorCOM al campo AntenaRFID.

```csharp
public ReadWriteTag(LectorCOM AntenaRFID)
```
...
El objeto LectorFEIG.LectorCOM que se comunica con la antena RFID.

## Fields

### <a id="HavanaTablet_ReadWriteTag_AntenaRFID"></a> AntenaRFID
